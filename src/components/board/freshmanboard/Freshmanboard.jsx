...
import FreshmanboardAdd from "./Freshmanboardadd";
const Freshmanboard=()=>{
  ...
  const countLikes = (likes) => {
    ...
    return(<Alldiv>
      <Bodydiv>
        <BoardInBody>
          <Titlediv>새내기 게시판</Titlediv>


          {click ? (
            <FreshmanboardAdd onAddPost={handleAddPost} onCancel={handleAddClick} />
          ) : (
