  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        ...
        setCommentCount(
          response.data.freshmanComment.reduce(
          ...
          {post ? (
            <>
              <SecondIndetailBody>
                ...
                {click ? (
                  <Freshmanboardedit id={post.id} onCancel={handleAddClick} />
                ) : (
                  <>
                ...
                <>
                  {post.freshmanComment.length > 0 ? (
                    post.freshmanComment.map((comment) => (
...
export default Freshmanboarddetail;
